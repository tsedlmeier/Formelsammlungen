...
\subsection{Zeitfenster}
  \begin{right}
      \includegraphics[width=.18\textwidth]{./img/rect.png}
  \end{right}
  \begin{right}
      \includegraphics[width=.18\textwidth]{./img/hamming.png}
  \end{right}
  \begin{right}
      \includegraphics[width=.18\textwidth]{./img/hann.png}
  \end{right}
...
\end{itemize}
\begin{itemize}
    \item $(e^{j\Omega}-z_{01}) = D_{01}e^{j\phi_{01}}$ und $(e^{j\Omega}-z_{02}) = D_{02}e^{j\phi_{02}}$\\ \item $(e^{j\Omega}-z_{\infty 1}) = D_{\infty 1}e^{j\phi_{01}}$ und $(e^{j\Omega}-z_{01}) = D_{\infty 2}e^{j\phi_{\infty 2}}$ \end{itemize}
  \begin{center}
