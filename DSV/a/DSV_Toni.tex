...
Bestimmung eines einzelnen DFT-Spektralwert X(n). Gleicher Rechenaufwand wie FFT aber Blocklänge N muss keine 2er Potenz sein. $\tilde{x}(k)=[x(0..N-1) \ 0]$ (N-ter Wert 0 setzen)
  \begin{mdframed}[style=exercise]
    \begin{align}
        ...
        n = -j\cdot\frac{N}{2\cdot\pi}\cdot ln(h(1)) -> f_{Goertzel}=\frac{f_{Abtast}}{N}\cdot n
    \end{align}
  \end{mdframed}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% IIR-Filter %%%%%%%%%%%%%%%%%%%%%%%%%%%%%(%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
	...
	\item Typ 2: kein Hoch- \& Tiefpass
	\item Typ 3: kein Hochpass
	\item Typ 4: kein Tiefpass
\end{itemize}
