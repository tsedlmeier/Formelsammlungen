...
Operationsstufen werden mit Pipelineregister gebuffert\\
\textbf{Vorteil: } Massive Erhöhung der Taktfrequenz\\
\textbf{Nachteil: } Zusätzliche Register $\rightarrow$\\
\textbf{Mittlere Gruppenlaufzeit: } $\tau_{Gruppe}=(\lfloor{}\frac{p}{2}\rfloor{} + n)\cdot\frac{1}{f_{clk}}$\\
\textbf{Pipeline-Reg.-Anzahl (n): } In jedem Strang gleich\\ 
\textbf{}
  \begin{center}
...
\textbf{ACHTUNG: } Pipeline-Regs. bei Bedarf nach Multiplizierer
