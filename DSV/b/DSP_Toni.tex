...
Bsp. Q3.3 $(100.001)_2$ 
  ...
  \begin{center}
      \includegraphics[width=.45\textwidth]{./img/dynamic.png}
  \end{center}
...
\begin{itemize}
    ...
    \item keine Einschwingzeit $\rightarrow$ stabil
    \item hoher Speicherbedarf (LUT)
    \item robuster Phasen/Frequenzwechsel mit sofortiger Wirkung 
\end{itemize}
  \begin{mdframed}[style=exercise]
    \begin{align}
...
\section{Blocksignalverarbeitung}
  \begin{center}
      \includegraphics[width=.35\textwidth]{./img/frame.png}
  \end{center}
...
Jeder Sample generiert einen Interrupt
  \begin{center}
      \includegraphics[width=.35\textwidth]{./img/buffers.png}
  \end{center}
...
\section{FIR in FPGA}
  ...
  \end{center}
Max. Sampling Frequency determiniert von Filterordnung N
  \begin{mdframed}[style=exercise]
    \begin{align}
        f_{sampling}=\frac{1}{T_{mult}+NT_{add}}
    \end{align}
  \end{mdframed}

\subsection{FIR - Pipelined} 
Massive Erhöhung der Taktfrequenz durch einfügen von Pipelineregistern.
  \begin{center}
      \includegraphics[width=.35\textwidth]{./img/firpipeline.png}
  \end{center}
Max. Sampling Frequency $f_{sampling}$ abh. von N und Anzahl der Pipelineregistern $N_{pipe}$
  \begin{mdframed}[style=exercise]
    \begin{align}
        f_{sampling}=\frac{1}{T_{mult}+ \frac{N}{N_{pipe}} T_{add}}
    \end{align}
  \end{mdframed}
...
\subsection{FIR - transposed (DF1)}
  ...
  \end{center}
Max. Sampling Frequency $f_{sampling}$
  \begin{mdframed}[style=exercise]
    \begin{align}
...
Hier Variante mit N gerade.
  \begin{center}
      \includegraphics[width=.35\textwidth]{./img/firlinear.png}
  \end{center}
Filter Koeffizienten und Impulsantwort $h(k)$ symmetrisch. $\rightarrow$ Hälfte der Multiplizierer
...
\section{Multirate Signalprocessing}

\subsection{CIC Cascaded Integrator Comb}
  \begin{center}
      \includegraphics[width=.35\textwidth]{./img/cic.png}
  \end{center}
CIC-Filter = FIR-Filter zur Abtastratenkonvertierung\\
Eigenschaften:
\begin{itemize}
    \item Alle Koeffizienten sind 1 $\rightarrow$ kein Multiplizierer 
\end{itemize}
